...
public class ExternalMultiCallTimeoutTest
{
            ...
            throws KojiClientException
    {
        ...
        if ( timeoutMillis != 0L )
        {
            config = new SimpleKojiConfigBuilder().withKojiURL( hubUrl ).withTimeout( (int) TimeUnit.MILLISECONDS.toSeconds( timeoutMillis ) ).build();
        }
        else
        {
        ...
        try
        {
            ...
            return helper.listArchives( queries, null );
        }
