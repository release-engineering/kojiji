...
public class KojiBooleanOrIntegerConverter
                implements Converter<KojiBooleanOrInteger>
{
    @Override
    public KojiBooleanOrInteger parse( Object object )
    {
        if ( object == null )
        {
            return null;
        ...
        return KojiBooleanOrInteger.getFor( object );
    }
