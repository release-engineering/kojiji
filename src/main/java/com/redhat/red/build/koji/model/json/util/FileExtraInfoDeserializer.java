 ...
 */
public class FileExtraInfoDeserializer
        extends StdDeserializer<FileExtraInfo>
{
    public FileExtraInfoDeserializer()
    {
        super( FileExtraInfo.class );
    }

    @Override
    public FileExtraInfo deserialize( JsonParser jp, DeserializationContext ctxt )
            ...
            if ( token == JsonToken.START_OBJECT )
            {
                ...
                switch ( field )
                {
                    case ( MAVEN_INFO ):
                    {
                        ...
                        return new FileExtraInfo( mvnInfo );
                    }
                    default:
                    {
