...
public class GetMavenBuildRequest
{
    ...
    public GetMavenBuildRequest() {}

    public GetMavenBuildRequest( KojiIdOrName buildIdOrName )
    {
        this.buildIdOrName = buildIdOrName;
    }

    public GetMavenBuildRequest( String buildName )
    {
        this.buildIdOrName = new KojiIdOrName( buildName );
    }

    public GetMavenBuildRequest( int buildId )
    {
